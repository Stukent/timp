          ...
          <div className="details-container">
            ...
            <div className="column-wrapper">
              <ul className="one">
                ...
                <li>
                      All repair services are provided by manufacturer
                      or authorized repairers to ensure quality
                </li>
                <li>
                      The coverage is for mechanical and electric breakdown and the
                     repair liable is limited to 125% of the product purchase price
                </li>
              </ul>
              ...
              <ul className="two">
                <li>The Fortress Extended Warranty Service is provided by Fortress</li>
                <li>
                  All repair services are provided by manufacturer or authorized
                  repairers to ensure quality
                </li>
                <li>
                  The coverage is for mechanical and electric breakdown and the
                  repair liable is limited to 125% of the product purchase price
